...
python -m pytest tests/ -q   # 跑测试(当前 376 个全绿)
...
python scripts_gen/sync_global_index.py --dry-run          # 跨境指数批量同步(港股/全球入 index_daily;美股待东财可达)
